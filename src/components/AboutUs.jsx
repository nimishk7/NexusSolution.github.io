        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
              With over 15+ years of experience, Nexus Solutions specializes in the supply of Double Wall Corrugated (DWC) Pipes and custom pipe accessories for underground drainage, sewerage, and cable protection networks.
            </p>
